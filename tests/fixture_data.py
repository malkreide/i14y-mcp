...
statt Zahlen hineinzuschreiben — eine feste Anzahl waere beim naechsten
...
def fixture_records(name: str) -> list[Any]:
    """Die Datensaetze der Fixture — Sammlungen als Liste, Detail als Einzelobjekt."""
    data = fixture_json(name)["data"]
